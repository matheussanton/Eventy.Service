            ...
            modelBuilder.Entity("Eventy.Service.Domain.Entities.EventEntityDomain", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 27, 23, 35, 37, 872, DateTimeKind.Utc).AddTicks(8960),
                            CreatedBy = new Guid("e100ec94-d169-41c7-9884-625b11b53e00"),
                            Deleted = false,
                            Description = "Eventy is a event management system",
                            EndDate = new DateTime(2023, 12, 28, 0, 5, 37, 872, DateTimeKind.Utc).AddTicks(8956),
                            GoogleMapsUrl = "https://g.co/kgs/mxYNbz",
                            Location = "Eventy's office",
                            Name = "Eventy Demo",
                            StartDate = new DateTime(2023, 12, 27, 23, 35, 37, 872, DateTimeKind.Utc).AddTicks(8955),
                            Status = (short)1
                        });
                });
            ...
            modelBuilder.Entity("Eventy.Service.Domain.Entities.UserEntityDomain", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 27, 23, 35, 37, 872, DateTimeKind.Utc).AddTicks(6489),
                            CreatedBy = new Guid("e100ec94-d169-41c7-9884-625b11b53e00"),
                            Deleted = false,
                            Email = "demo@eventy.com",
                            Name = "Demonstration User",
                            Password = "D8JbWxbnXKDiPvF1bG6sfg==|jf2wEVz2XcT+htNw25He0jGS2FnXiYNl60KBI6H5gSs=",
                            Role = (short)1,
                            Status = (short)1
                        });
                });
