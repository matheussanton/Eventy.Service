    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69414953-6494-481b-98e0-99d02d8cd412"), new DateTime(2023, 12, 27, 17, 5, 30, 779, DateTimeKind.Utc).AddTicks(6577), new Guid("e100ec94-d169-41c7-9884-625b11b53e00"), new DateTime(2023, 12, 27, 17, 5, 30, 779, DateTimeKind.Utc).AddTicks(6573), false, null, null, "Eventy is a event management system", "https://g.co/kgs/mxYNbz", "Eventy's office", "Eventy Demo", (short)1, null, null });

            migrationBuilder.InsertData(
                table: "user",
                columns: new[] { "id", "created_at", "created_by", "deleted", "deleted_at", "deleted_by", "email", "name", "password", "role", "status", "updated_at", "updated_by" },
                values: new object[] { new Guid("e100ec94-d169-41c7-9884-625b11b53e00"), new DateTime(2023, 12, 27, 17, 5, 30, 779, DateTimeKind.Utc).AddTicks(4200), new Guid("e100ec94-d169-41c7-9884-625b11b53e00"), false, null, null, "demo@eventy.com", "Demonstration User", "123", (short)1, (short)1, null, null });
